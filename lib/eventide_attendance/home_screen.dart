...
class EventideAttendanceHomeScreen extends StatefulWidget {
  const EventideAttendanceHomeScreen({super.key});

  @override
  State<EventideAttendanceHomeScreen> createState() => _EventideAttendanceHomeScreenState();
}

class _EventideAttendanceHomeScreenState extends State<EventideAttendanceHomeScreen> {
